...
TOURNAMENT_DIR = os.path.join(AI_DATA_DIR, "tournament")
MODEL_PATH = os.path.join(AI_DATA_DIR, "model.pt")
PRE_TOURNAMENT_PATH = os.path.join(AI_DATA_DIR, "model.pre_tournament.pt")
TOURNAMENT_LOOPS_PATH = os.path.join(TOURNAMENT_DIR, "loops.json")
LOG_PATH = os.path.join(AI_DATA_DIR, "training_log.json")
...
STEP_LOG_PATH = os.path.join(AI_DATA_DIR, "step_log.jsonl")
BEHAVIOR_LOG_PATH = os.path.join(AI_DATA_DIR, "behavior_log.jsonl")
PLAYING_LOG_PATH = os.path.join(AI_DATA_DIR, "playing_log.json")
PLAYING_BEHAVIOR_LOG_PATH = os.path.join(AI_DATA_DIR, "playing_behavior_log.jsonl")
STEP_LOG_MAX_LINES = 1_000_000  # rotate step_log.jsonl at this many lines
TB_LOG_DIR = os.path.join(AI_DATA_DIR, "runs")
