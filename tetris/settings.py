...
MENU_ANIM_BLOCK_SIZE = 25         # block size for falling tetrominos (px)
MENU_ANIM_FALL_SPEED = 35         # vertical fall speed (px/s)
MENU_ANIM_MIN_SPAWN_INTERVAL = 2.0  # min seconds between spawns
MENU_ANIM_MAX_SPAWN_INTERVAL = 5.0  # max seconds between spawns
...
MENU_ANIM_EXPLODE_DELAY = (8.0, 16.0)  # seconds before explosion check
MENU_ANIM_EXPLODE_CHANCE = 0.008  # per-frame probability after delay
